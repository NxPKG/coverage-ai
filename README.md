...
Follow the steps in the README.md file located in the `templated_tests/python_readyapi/` directory to setup an environment, then return to the root of the repository, and run the following command to add tests to the **python readyapi** example:
```shell
coverage-ai \
